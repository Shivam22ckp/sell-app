...
class SharedPreferenceHelper {
  ...
  static String userPublishedKey = "USERPUBLISHEDKEY";
  static String userSecretKey = "USERSECRETKEY";
  ...
  Future<bool> saveUserPublished(String getUserPublished) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userPublishedKey, getUserPublished);
  }

  Future<bool> saveUserSecret(String getUserSecert) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userSecretKey, getUserSecert);
  }
  ...
  Future<String?> getUserPublished() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString(userPublishedKey);
  }
